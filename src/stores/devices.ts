...
export const deviceList = ref<DeviceItemType[]>([
  {
    name: '空气加湿器',
    code: 'b64d86a19dc7',
...
export const deviceCategoryList = ref<Array<DeviceCategoryItemType | '全部'>>([
  '全部',
  '温控',
  '安全',
  '娱乐',
...
export const deviceCategoryCurrent = ref<DeviceCategoryItemType | '全部'>(
  '全部'
)

export const deviceListByCategory = computed(() => {
